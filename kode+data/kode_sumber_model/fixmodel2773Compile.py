...
try:
    # Try to load the dataset file using the resource path
    df = pd.read_csv(resource_path('datahasil6.csv'))
except FileNotFoundError:
    print("Default dataset loaded as 'datahasil6.csv' was not found.")
